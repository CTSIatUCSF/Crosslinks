 ...
 */
@Path("researchers/{affiliation}")
public class ResearcherList {

	private static final Logger LOG = Logger.getLogger(ResearcherList.class.getName());
    ...
    public String getResearchers(@PathParam("affiliation") String affiliation) {
		String sql = "select * from vw_ResearcherList where affiliationName = ?";
