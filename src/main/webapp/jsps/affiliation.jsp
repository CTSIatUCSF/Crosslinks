...
<html>
<body>
	<a href = '<c:out value="${affiliation.baseURL}"/>'><c:out value="${affiliation.affiliationName}"/> Research Networking Site</a>  
	...
	<a href = '<c:out value="${affiliation.affiliationName}"/>/researchers'>Indexed researchers from <c:out value="${affiliation.affiliationName}"/></a><p> 
	...
	List of researchers at other affiliations that we think are also in <c:out value="${affiliation.affiliationName}"/>&nbsp;
	<a href = '<c:out value="${affiliation.affiliationName}"/>/possibleSamePeople?format=CSV'> (CSV)</a>&nbsp; 
	<a href = '<c:out value="${affiliation.affiliationName}"/>/possibleSamePeople?format=JSON'> (JSON)</a><p>
	 
	List of potential disambiguation conflicts for <c:out value="${affiliation.affiliationName}"/>&nbsp; 
	<a href = '<c:out value="${affiliation.affiliationName}"/>/possibleConflicts?format=CSV''>(CSV)</a>&nbsp;
	<a href = '<c:out value="${affiliation.affiliationName}"/>/possibleConflicts?format=JSON''>(JSON)</a><p>
